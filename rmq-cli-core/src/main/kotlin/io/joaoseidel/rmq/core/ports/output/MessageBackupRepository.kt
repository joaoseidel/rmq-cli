...
interface MessageBackupRepository {
 ...
 /**
  * Retrieves a list of processed messages associated with a specific operation.
  *
  * This function fetches all messages for the given operation that have been marked as processed.
  * It is useful for tracking messages that have already been handled or finalized within the operation's scope.
  *
  * @param operationId The unique identifier of the operation for which processed messages are to be retrieved.
  * @return A list of messages that have been processed for the specified operation.
  */
 fun getProcessedMessages(operationId: UUID): List<Message>
